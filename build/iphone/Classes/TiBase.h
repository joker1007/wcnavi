...
// in simulator we redefine to format for wcnavi Developer console
...
{\
	NSString * exceptionName = [@"org.wcnavi." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.wcnavi";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIwcnaviNativeItemNone = -1, 
	UIwcnaviNativeItemSpinner = -2,
	UIwcnaviNativeItemProgressBar = -3,
	
	UIwcnaviNativeItemSlider = -4,
	UIwcnaviNativeItemSwitch = -5,
	UIwcnaviNativeItemMultiButton = -6,
	UIwcnaviNativeItemSegmented = -7,
	
	UIwcnaviNativeItemTextView = -8,
	UIwcnaviNativeItemTextField = -9,
	UIwcnaviNativeItemSearchBar = -10,
	
	UIwcnaviNativeItemPicker = -11,
	UIwcnaviNativeItemDatePicker = -12,
	
	UIwcnaviNativeItemInfoLight = -13,
	UIwcnaviNativeItemInfoDark = -14,
	
	UIwcnaviNativeItemDisclosure = -15,
	
	UIwcnaviNativeItemContactAdd = -16
};
